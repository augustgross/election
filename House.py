...
# Load houseidential election data
...
def main():
    ...
    house_data_file = 'results/HOUSE.csv'
    
    # Load and process data
    census_data = load_and_process_census_data(census_data_files)
    house_data = load_house_data(house_data_file)
    
    # Merge census data with houseidential election results on 'Year'
    combined_data = pd.merge(house_data, census_data, on='Year', how='inner')
